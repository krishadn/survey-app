...
public class OptionDAO {
    ...
    public static Option getOptionsByOptId(int query) {

        String sql = "SELECT * FROM OPTION WHERE OPTID=?";
    ...
    public static int updateOptionTally(int optid, int tally) {
        
        String sql = "UPDATE OPTION SET TALLY = ? WHERE OPTID=?;";
